...
import {CrearCurrentProfile} from '../../action/profileAction'

class Navbar extends Component {

  onlogoutClick(e){
    e.preventDefault();
    this.props.CrearCurrentProfile()
...
export default connect(mapStateToProps,{logoutUser, CrearCurrentProfile})(Navbar);