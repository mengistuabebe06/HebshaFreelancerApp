          ...
          <div className="row gy-5 gx-4">
            <div className="col-lg-8">
              ...
              <div className="mb-5">
                ...
                <p>
                  ...
                  lorem sea magna. Rebum vero dolores dolores elitr vero dolores
                  magna, stet sea sadipscing stet et. Est voluptua et sanctus at
                  sanctus erat vero sed sed, amet duo no diam clita rebum duo,
                  accusam tempor takimata clita stet nonumy rebum est invidunt
                  stet, dolor.
                </p>
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <i className="fa fa-angle-right text-primary me-2"></i>Diam diam
            ...
            <div className="col-lg-4">
              ...
              >
                ...
                <p>
                  <i className="fa fa-angle-right text-primary me-2"></i>Vacancy:
                  123 Position
                </p>
                <p>
                  <i className="fa fa-angle-right text-primary me-2"></i>Job Nature:
                  Full Time
                </p>
                <p>
                ...
                <p>
                  <i className="fa fa-angle-right text-primary me-2"></i>Location:
                  New York, USA
                </p>
                <p className="m-0">
                  <i className="fa fa-angle-right text-primary me-2"></i>Date Line:
                  01 Jan, 2045
                </p>
              </div>
              <div
